...
INSERT INTO `category` (`id`, `name`) VALUES (4, 'ToDelete');
INSERT INTO `category` (`id`, `name`) VALUES (5, 'ToEdit');
...
INSERT INTO `question` (`id`, `title`, `text`, `category_id`, `user_id`, `is_closed`, `contains_correct_answer`) VALUES (4, 'Threads', 'How to create thread?', 3, 3, 0, 0);
...
INSERT INTO `answer` (`id`, `text`, `user_id`, `question_id`, `is_correct`) VALUES (4, 'there are few ways, using Thread and Runnable', 1, 3, 0);
