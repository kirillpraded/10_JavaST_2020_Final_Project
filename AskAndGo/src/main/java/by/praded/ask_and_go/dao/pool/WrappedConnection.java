...
public class WrappedConnection implements Connection {
    ...
    /*
    конекшен не закрывается, а убирается из сета taken и помещается в очередь доступных к использованию конекшенов
    перед этим autocommit возвращается в true
     */
    @Override
    public void close() {
        try {
